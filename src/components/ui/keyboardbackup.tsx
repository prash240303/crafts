...
export function KeyboardBackup({
  className,
  theme = "classic",
  enableSound = true,
  enableHaptics = true,
...
function Key({
  ...
  return (
    <button
      ...
      className="flex items-end cursor-pointer touch-none appearance-none border border-red-500 bg-transparent p-0 text-left focus:outline-none"
    >
      <div
        className={cn(
          "relative overflow-hidden h-[45px] rounded-full border border-black/40 flex items-start justify-center transition-all duration-100",
          isPressed && "h-[40px]",
        )}
        style={{
          width: `${width}px`,
      ...
      >
        <div
          className={cn(
            "relative z-10 h-[37px] border border-neutral-600 rounded-full  transition-all duration-100",
